...
#endif
{
	...
	partial class LibZResolver
	{
        ...
        /// </param>
        /// <exception cref="ArgumentException">codecName is null or empty.</exception>
        /// <exception cref="ArgumentNullException">decoder is null.</exception>
	...
	namespace Internal
	{
		...
		partial class LibZReader: IDisposable
		{
            ...
            /// <exception cref="ArgumentException">Container file seems to be corrupted.</exception>
            /// <exception cref="NotSupportedException">Not supported version of container file.</exception>
            ...
            /// <returns>Buffer of bytes.</returns>
            /// <exception cref="IOException">LibZ container is corrupted</exception>
